							...
							<div role="tabpanel" class="tab-pane" id="data">
								<table class="table-data-sheet">
									<tbody>
										...
										<tr class="even">
											<td>Thể loại</td>
											<c:if test="${books.theloaisach.maTheLoai == 1}">
												<td>Tiểu Thuyết</td>
											</c:if>
											<c:if test="${books.theloaisach.maTheLoai == 2}">
												<td>Truyện Dài</td>
											</c:if>
											<c:if test="${books.theloaisach.maTheLoai == 3}">
												<td>Truyện Ngắn</td>
											</c:if>
											<c:if test="${books.theloaisach.maTheLoai == 4}">
