		...
		<div>
			<div class="left">
				<form action="${pageContext.request.contextPath}/uploadfile"
					...
					Chọn hình ảnh : <input type="file" value="Upload File" name="file" /><br />
					<br /> <input name="submit" value="Cập nhật hình ảnh"
						type="submit" />
				</form>
			</div>
			<div class="right">
				...
				<img class="img"
					src="${pageContext.request.contextPath}/assets/img/shop/
					<c:choose>
